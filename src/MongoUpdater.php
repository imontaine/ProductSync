...
class MongoUpdater
{
    ...
    public static $EXCLUDE_ADDITIONAL_ATTRS = ["amxnotif_hide_alert", "aw_os_category_text", "aw_os_product_text", "canonical_cross_domain", "disable_amazonpayments", "featured_product_image", "gift_wrapping_price", "price_promo_text_grid", "shop_options", "show_in_crosssell_result"];
